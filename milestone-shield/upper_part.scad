...
difference(){
	...
	translate([shield_common_thickness + phone_power_to_right, 0, connector_thickness])
		cube([phone_power_width, shield_common_thickness, phone_bottom_thickness - connector_thickness]);
	translate([0, phone_volume_button_to_edge, phone_volume_button_to_bottom])
	...
	translate([0, upper_part_height, 0])
		rotate([0, 0, 180])
			translate([0, phone_camera_button_to_edge, phone_camera_button_to_bottom])
				rotate([0, 0, 90])
